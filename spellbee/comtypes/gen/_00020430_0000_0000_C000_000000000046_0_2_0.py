...
IFontDisp = Font
__all__ = [ 'FONTITALIC', 'Color', 'VgaColor', 'LoadPictureConstants',
           'IFont', 'Font', 'FontEvents', 'OLE_HANDLE', 'OLE_COLOR',
           'FONTSTRIKETHROUGH', 'OLE_YSIZE_PIXELS', 'FONTNAME',
           'OLE_OPTEXCLUSIVE', 'OLE_XSIZE_PIXELS',
           'OLE_ENABLEDEFAULTBOOL', 'Default', 'FONTBOLD', 'FONTSIZE',
           'Checked', 'OLE_CANCELBOOL', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_PIXELS', 'OLE_TRISTATE', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_CONTAINER', 'Gray', 'OLE_YPOS_HIMETRIC',
           'FONTUNDERSCORE', 'Picture', 'StdFont', 'Unchecked',
           'OLE_XPOS_PIXELS', 'StdPicture', 'OLE_YSIZE_HIMETRIC',
           'OLE_XPOS_HIMETRIC', 'IPicture', 'OLE_XSIZE_HIMETRIC',
           'OLE_YSIZE_CONTAINER', 'IFontDisp', 'Monochrome',
